...
<body>
    ...
    <div class="login text-center" style="margin-top : 70px;">
        ...
        <p class="lead fw-normal text-muted mb-0">Daftar Akun</p>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 shadow p-3 mb-5 bg-body rounded">
                ...
                <div class="mb-3 m-2">
                    ...
                    <input type="ttl" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 m-2">
                    <p class="email-text">
                        <label for="klm" class="form-label">Jenis Kelamin</label>
                    </p>
                    <input type="klm" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3 m-2">
                    <p class="email-text">
